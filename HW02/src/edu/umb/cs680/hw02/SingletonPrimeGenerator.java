...
public class SingletonPrimeGenerator {
    ...
    protected static SingletonPrimeGenerator singleton_instance =null;
    ...
    public static SingletonPrimeGenerator getInstance(long from, long to){
        ...
        if (singleton_instance==null){
            singleton_instance= new SingletonPrimeGenerator(from,to);
        }
    ...
    public static void main(String[] args) {
        ...
        gen.generatePrimes();
        SingletonPrimeGenerator a = SingletonPrimeGenerator.getInstance(1,100);

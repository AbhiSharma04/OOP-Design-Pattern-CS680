...
public class Directory extends FSElement {
    ...
    public LinkedList<FSElement> getChildren(){
        ...
        Collections.sort(this.FSELement_List,new AlphabeticalComparator());
    ...
    public void appendChild(FSElement child){
        ...
        Collections.sort(FSELement_List,new AlphabeticalComparator());
    ...
    public LinkedList<Directory> getSubDirectories(){
        Collections.sort(this.Directory_List,new AlphabeticalComparator());
    ...
    public LinkedList<File> getFiles(){
        Collections.sort(this.File_List,new AlphabeticalComparator());
